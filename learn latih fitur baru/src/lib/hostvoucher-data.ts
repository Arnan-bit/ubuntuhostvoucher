...
export const translations: any = {
    en: {
        tagline: "Your #1 source for exclusive tech & digital service deals!",
        picksAndDealsTitle: "👇 Choose Your Perfect Deal Below 👇",
        hottestDeals: "Today's Hottest Deals",
        hosting: "Hosting",
        ...
        comparing: "Comparing",
        noDeals: "No deals available for this category.",
        searchPlaceholder: "Search by brand or catalog no...",
        footerRights: "All rights reserved. Built with ❤️ for the best deals.",
        free: "Free",
        ...
        aboutDescription: "HostVoucher is your premier global destination for curated digital deals. We partner with world-renowned brands like Hostinger, DigitalOcean, and NordVPN to bring you exclusive, verified promo codes and offers. Our mission is to empower your digital journey by providing unparalleled savings on essential services, ensuring you always get premium value.",
...
export const currencyData = [
    ...
    { country: 'Indonesia', lang: 'Bahasa Indonesia', code: 'IDR', symbol: 'Rp', key: 'IDR' },

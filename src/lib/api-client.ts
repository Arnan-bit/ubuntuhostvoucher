...
export const reorderCatalog = (reorderedProducts: any[]) => {
    return action('reorderCatalog', { products: reorderedProducts });
};
...
export const saveCurrencyRates = (payload: any) => {
    return action('saveCurrencyRates', payload);
};
